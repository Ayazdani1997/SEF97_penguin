...
urlpatterns = [
    ...
    path('finalize', views.finalizePoll, name='finalizePoll'),
    path('revoke', views.revokePoll, name='revokePoll'),
    ...
    path('checkOverlap', views.checkOverlapTest, name='checkOverlapTest'),
